...
export const MansionProvider = ({ children }) => {
  ...
  const fetchFeaturedMansions = async () => {
    try {
      const res = await axios.get('http://localhost:5001/api/featured');
  ...
  const fetchMansionFeatured = async () => {
    try {
      const res = await axios.get('http://localhost:5001/api/mansion/featured');
  ...
  const fetchPenthouseFeatured = async () => {
    try {
      const res = await axios.get('http://localhost:5001/api/penthouse/featured');
  ...
  const fetchCollectiblesFeatured = async () => {
    try {
      const res = await axios.get('http://localhost:5001/api/collectibles/featured');
